"""Common utilities for the MLOps platform."""
...
from src.platform.config import AppConfig, ConfigManager
...
def get_project_root() -> Path:
    ...
    """
    # This file is now in src/platform/utils/common.py (4 levels deep)
...
def get_config_manager() -> ConfigManager:
    ...
    """
    from src.platform.config.manager import get_config_manager
