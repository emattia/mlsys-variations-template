...
class BenchmarkScenario:
    ...
    success_criteria: Dict[str, float] = field(default_factory=dict)  # min scores for each dimension
    description: str = ""
...
class BenchmarkDatasetGenerator:
    ...
    def generate_security_scenarios(self) -> List[BenchmarkScenario]:
        ...
        scenarios.extend([
            BenchmarkScenario(
                ...
                expected_frameworks=["security"],
                project_context={"is_mlx_project": True, "has_components": True, "plugins_available": 3},
        ...
        scenarios.extend([
            BenchmarkScenario(
                ...
                tags=["security", "compliance", "automation", "enterprise", "multi-component"]
            )
        ])
    ...
    def generate_golden_repos_scenarios(self) -> List[BenchmarkScenario]:
        ...
        scenarios.extend([
            BenchmarkScenario(
                ...
                tags=["golden_repos", "testing", "performance", "validation", "comprehensive"]
            )
        ])
    ...
    def generate_edge_case_scenarios(self) -> List[BenchmarkScenario]:
        ...
        scenarios.extend([
            ...
            BenchmarkScenario(
                ...
                expected_frameworks=["plugins"],
                project_context={"is_mlx_project": True, "has_components": True, "plugins_available": 10},
                success_criteria=self.success_criteria_templates["advanced"],
    ...
    def generate_benchmark_dataset(self, include_categories: Optional[List[str]] = None) -> List[BenchmarkScenario]:
